      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <section className="space-y-4 p-4 bg-gray-50 rounded-lg">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <select name="category" value={formData.category} onChange={handleChange} className="block w-full rounded-md border-gray-300 shadow-sm p-3 border bg-white focus:border-purple-500 focus:ring-purple-500" aria-label="Product category" required>
        ...
        <section className="p-4 bg-gray-50 rounded-lg space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <select name="auctionDuration" value={formData.auctionDuration} onChange={handleChange} className="block w-full rounded-md border-gray-300 shadow-sm p-3 border bg-white focus:border-purple-500 focus:ring-purple-500" aria-label="Auction duration" required>
