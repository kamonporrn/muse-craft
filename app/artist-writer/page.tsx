        ...
        <div className="bg-white rounded-2xl shadow-md p-6 mb-6">
          ...
          <div className="flex flex-wrap items-center justify-between mt-6">
            ...
            <div className="flex gap-3 mt-4 md:mt-0">
              <button className="bg-yellow-300 hover:bg-yellow-400 text-black font-semibold px-3 py-2 rounded-lg flex items-center gap-2 text-sm">
                <FaStore /> View Storefront
              </button>
              <button className="bg-purple-600 hover:bg-purple-700 text-white font-semibold px-3 py-2 rounded-lg flex items-center gap-2 text-sm">
                <FaGavel /> Join Auction
              </button>
            </div>
          </div>
